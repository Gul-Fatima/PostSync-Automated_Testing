...
WebUI.click(findTestObject('Page_Welcome  PostSync/div_DANDELIONS'))

WebUI.click(findTestObject('Page_DANDELIONS - PostSync  PostSync/a_Delete'))

WebUI.verifyTextNotPresent('DANDELIONS', false)
